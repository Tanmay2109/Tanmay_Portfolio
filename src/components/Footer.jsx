      ...
      <div className="container" style={{
        ...
        <div style={{
          ...
          <a href="https://linkedin.com/in/tanmaypatil2109" target="_blank" rel="noreferrer" 
             className="glass-panel social-btn" style={{ width: '45px', height: '45px', display: 'flex', alignItems: 'center', justifyContent: 'center', borderRadius: '50%', color: 'var(--text-primary)' }}
